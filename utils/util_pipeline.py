...
def build_optimizer(p_pline, model):
    ...
    with torch.no_grad():
        ...
        model.img_cls.bn1.weight.copy_(state_dict['bn1.weight'])
        model.img_cls.bn1.bias.copy_(state_dict['bn1.bias'])
        model.img_cls.bn1.running_mean.copy_(state_dict['bn1.running_mean'])
        model.img_cls.bn1.running_var.copy_(state_dict['bn1.running_var'])
        model.img_cls.bn1.num_batches_tracked.copy_(state_dict['bn1.num_batches_tracked'])
        
        model.img_cls.conv2.weight.copy_(state_dict['conv2.weight'])
        model.img_cls.conv2.bias.copy_(state_dict['conv2.bias'])
        model.img_cls.bn2.weight.copy_(state_dict['bn2.weight'])
        model.img_cls.bn2.bias.copy_(state_dict['bn2.bias'])
        model.img_cls.bn2.running_mean.copy_(state_dict['bn2.running_mean'])
        model.img_cls.bn2.running_var.copy_(state_dict['bn2.running_var'])
        model.img_cls.bn2.num_batches_tracked.copy_(state_dict['bn2.num_batches_tracked'])
        
        model.img_cls.conv3.weight.copy_(state_dict['conv3.weight'])
        model.img_cls.conv3.bias.copy_(state_dict['conv3.bias'])
        model.img_cls.bn3.weight.copy_(state_dict['bn3.weight'])
        model.img_cls.bn3.bias.copy_(state_dict['bn3.bias'])
        model.img_cls.bn3.running_mean.copy_(state_dict['bn3.running_mean'])
        model.img_cls.bn3.running_var.copy_(state_dict['bn3.running_var'])
        model.img_cls.bn3.num_batches_tracked.copy_(state_dict['bn3.num_batches_tracked'])
        
        model.img_cls.adjust.weight.copy_(state_dict['adjust.weight'])
        model.img_cls.adjust.bias.copy_(state_dict['adjust.bias'])
        model.img_cls.fc.weight.copy_(state_dict['fc.weight'])
        model.img_cls.fc.bias.copy_(state_dict['fc.bias'])
    ###########################################################################
